      ...
      <div className="flex flex-col mt-20 p-5 items-center ">
        <div className="p-3 flex flex-col gap-5">
          <p className="flex items-center gap-1">
            <BiSolidLeaf className="text-[#9EC63C] text-2xl" /> Our Gallery
            Image{" "}
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 auto-rows-[400px] gap-6 mt-10">
          <img
            src={Gallery1}
            alt={Gallery1}
        ...
        <div className="relative  w-full  mt-20 flex items-center justify-center">
          ...
          <div className="relative h-full w-full top-0 opacity-100 rounded-2xl text-white z-40">
            <div className="relative flex h-full flex-col gap-10 md:flex-row rounded-2xl  ">
              ...
              <div className="px-5 flex items-end">
                <div className="relative h-full w-full flex md:items-end md:justify-end lg:scale-110 lg:mb-6">
                  <img src={Farmer} alt={Farmer} className=" object-cover" />
                </div>
              </div>
            </div>
          </div>
