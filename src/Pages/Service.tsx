...
const Service = () => {
  return (
    <div className="flex flex-col gap-10 items-center w-full mt-10 bg-[#EDF2EB]">
      ...
      <div className=" border border-[#C8D7C3] flex flex-col items-center rounded-2xl">
            <div className="w-full grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 -mt-5 px-20">
            ...
            <div className="flex max-w-[90rem] items-center flex-col-reverse md:flex-row gap-10 p-10">
